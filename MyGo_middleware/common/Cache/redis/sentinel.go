...
//
// func NewSentinelPool() *Cache.Pool {
// 	sntnl := &sentinel.Sentinel{
// 		Addrs:      []string{"192.168.45.104:26379"},
// 		MasterName: "mymaster",
// 		Dial: func(addr string) (redis.Conn, error) {
// 			timeout := 500 * time.Millisecond
// 			c, err := Cache.DialTimeout("tcp", addr, timeout, timeout, timeout)
// 			if err != nil {
// 				return nil, err
// 			}
// 			return c, nil
...
// 				return nil, err
// 			}
// 			c, err := Cache.Dial("tcp", masterAddr)
// 			if err != nil {
// 				return nil, err
// 			}
// 			return c, nil
...
type Sentinel struct {
	...
	// Note that as per the Cache-sentinel client guidelines, a timeout is mandatory
